...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=Leonikes\\SQLEXPRESS;Database=MyGuitarShop;User Id=migrations_owner;Password=Iaminthefloor;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Address>(entity =>
        {
            entity.HasKey(e => e.AddressId).HasName("PK__Addresse__091C2A1BF66DEBBE");
        ...
        {
            entity.HasKey(e => e.AdminId).HasName("PK__Administ__719FE4E8C65C996C");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categori__19093A2BEB288C2D");

            entity.HasIndex(e => e.CategoryName, "UQ__Categori__8517B2E0F353A512").IsUnique();
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__A4AE64B8009B8D57");

            entity.HasIndex(e => e.EmailAddress, "UQ__Customer__49A147408A68022C").IsUnique();
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__C3905BAF2459E52F");
        ...
        {
            entity.HasKey(e => e.ItemId).HasName("PK__OrderIte__727E83EB97FA459D");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6ED44A879B6");

            entity.HasIndex(e => e.ProductCode, "UQ__Products__2F4E024F328C599C").IsUnique();
